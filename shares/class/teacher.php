	            ...
	            <section class="panel">
		            <header class="panel-heading bg-info">
		                <h1 class="text-infos py-4 pl-3tea py-2">
		                	<?='Teachers for '.ucwords(strtolower($school_name)); ?>
		                	<a href="<?=base_url('admin/section/school/'.$school_id.'/'.url_title(strtolower($school_name), 'dash', true));?>" class="pull-right btn btn-default btm-md">Go Back</a>
		                </h1> 
		            </header>
       ...
       <div id="modal_form" class="modal fade" role="dialog">
	            ...
	            <div class="modal-content">
		                			...
		                			<div class="row">
		                				<div class="col-md-4">
		                					<div class="form-group">
		                						<label class="control-label col-md-12">Teacher Name</label>
				                                <div class="col-md-12">
				                                    <input name="name" placeholder="Teacher's name" class="form-control" type="text">
	                    					...
	                    					<div class="form-group">
	                    						<label class="control-label col-md-12">Qualification</label>
				                                <div class="col-md-12">
				                                    <input type="text" name="qualification" class="form-control" placeholder="qualification Please">
				                                    <span class="help-block text-danger"></span>
				                                </div>
	                    					</div>
		                				</div>
		                				<div class="col-md-4">
	                    					...
	                    					<div class="form-group">
					                            ...
					                            <div class="col-md-12">
					                                <input name="dob" placeholder="Staff Birthday" class="form-control" type="date" required>
					                                <span class="help-block text-danger"></span>
					                            </div>
	                    					</div>
	                    					<div class="form-group">
				                                ...
				                                <div class="col-md-12">
				                                  <input type="text" name="nationality" class="form-control" placeholder="Teacher Nationality">
				                                  <span class="help-block text-danger"></span>
				                                </div>
	                    					</div>
	                    					<div class="form-group">
				                               ...
				                               <div class="col-md-12">
				                                  <input type="text" name="department" class="form-control" placeholder="Teacher Department">
				                                  <span class="help-block text-danger"></span>
				                               </div>
	                    					</div>
	                    					<div class="form-group">
                    						  <label class="control-label col-md-12">Teacher's Address</label>
				                                <div class="col-md-12">
	                ...
	                <div class="modal-footer card-footer">
	                    <div class="form-data mt-2 d-flex">
	                    	<button type="button" id="btnSave" onclick="save_teacher()" class="btn btn-primary"></button>
		                			...
		                			<div class="row">
		                				<div class="col-md-4">
		                					...
		                					<div class="form-group">
	                    						<label class="control-label col-md-12">Qualification</label>
				                                <div class="col-md-12">
				                                   <input type="text" name="v_qualification" class="form-control" readonly>
				                                    <span class="help-block text-danger"></span>
				                                </div>
	                    					</div>
	                    					<div class="form-group">
	                    						<label class="control-label col-md-12">Designation</label>
				                                <div class="col-md-12">
				                                  <input type="text" name="v_designation" class="form-control" readonly>
				                                    <span class="help-block text-danger"></span>
				                                </div>
	                    					</div>
		                				</div>
		                				<div class="col-md-4">
	                    					...
	                    					<div class="form-group">
	                    						<label class="control-label col-md-12">Date of Birth</label>
					                            <div class="col-md-12">
					                                <input name="v_dob" class="form-control" type="date" required>
					                                <span class="help-block text-danger"></span>
					                            </div>
	                    					</div>
	                    					<div class="form-group">
	    ...
	    <script type="text/javascript">
		    ...
		    $(document).ready(function (){
		    	$('#staffNav').css('background-color','#61a434');
		        $('#table').DataTable({
		            "processing": true,
		            "serverSide": true, 
		            "order": [], 
		            ...
		            buttons: [
		                ...
		                },
		                {
		                    ...
		                    filename:  "<?='Teacher for '.ucwords(strtolower($school_name)); ?>",
		                    extension: '.xlsx',
		                    exportOptions: {
		                        columns: [1,2,3,4,5]
		                    },
		                ...
		                {
		                    extend: 'print',
		                    title: "<h3 class='text-center'><?=$this->systemdata->sname; ?></h3><h4 class='text-center'> <?='Teacher for '.ucwords(strtolower($school_name)); ?></h4><h5 class='text-center'>Printed On <?php echo date('l, d F, Y'); ?></h5>",
		                    exportOptions: {
		                        columns: [1,2,3,4,5,6]
		                    },
		            ...
		            "ajax": {
		                "url": "<?php echo base_url('admin/teachers/generate_teacher/'.$school_id);?>",
		                "type": "POST"
		            },
	        ...
	        function previewTeacherProfileImage() {
	            var oFReader = new FileReader();
	            oFReader.readAsDataURL(document.getElementById("UserProfile").files[0]);
	            oFReader.onload = function (oFREvent) {
	            document.getElementById("viewUserProfile").src = oFREvent.target.result;
		    ...
		    function update_teacher(id) {
		        ...
		        $.ajax({
		             url: "<?php echo base_url('admin/teachers/get_records_by_techer_id');?>/" + id,
		             type: "GET",
		             dataType: "JSON",
		             success: function (data){
		                $('[name="teacherid"]').val(data.id);
		                $('[name="name"]').val(data.name);
		                $('[name="dob"]').val(data.dob);
		                $('[name="gender"]').val(data.sex);
		                ...
		                // show-profile photo
		                if (data.photo){
		                  $('#show_profile div').html('<img src="'+base_url+'uploads/teachers/'+data.photo+'" class="img-center" style="width:210px;height:210px">');
		                }else{
		            ...
		            {
		                swal("Error Occured!", "Teacher Record couldnot be displayed Now!", "error");
		            }
		        });
		    }
		    ...
		    function save_teacher(){
		        ...
		        var url;
		        if (save_method == 'add') {
		            url = "<?php echo base_url('admin/teachers/add_new_teacher');?>";
		        } else {
		            url = "<?php echo base_url('admin/teachers/update_teacher_records');?>";
		        }
		        ...
		        $.ajax({
		            ...
		            success: function (data){
		                ...
		                if (data.status){
		                    ...
		                    reload_table();
		                    if (save_method == 'add') {
		                        swal("Teacher Added!", "New Teacher has been added Successfully!", "success");
		                    } else {

		                        swal("Teacher Updated!", "Teacher Records Updated Successfully!", "success");
		                    }
		                }
		                else if(data === 'teacher_name_exists'){
		                    swal("Sorry, Teacher Name Exist!", "New Teacher Name already Taken!", "error");   
		                }
		                    ...
		                    if (save_method == 'add') {
		                        swal("Access Denied!", "You're not Authorized to create any new Teacher!", "error");
		                    } else {
		                        swal("Access Denied!", "You're not Authorized to update any Teacher!", "error");
		                    }
		                } else
		                {
		            ...
		            {
		                if (save_method == 'add') {
		                    swal("Error Occured!", "New Teacher Records couldn't be Added!", "error");
		                    $('#btnSave').text('Add'); //change button text
		                    $('#btnSave').attr('disabled', false); //set button enable  
		                }else{
		                    swal("Error Occured!", "Teacher Records couldn't be Update!", "error");
		    ...
		    function view_teacher(teacher_id) {
		    	//Ajax Load data from ajax
		        $.ajax({
		            url: "<?php echo base_url('admin/teachers/get_records_by_techer_id') ?>/" + teacher_id,
		            type: "GET",
		            dataType: "JSON",
		            success: function (data){
		                $('[name="v_name"]').val(data.name);
		                $('[name="v_dob"]').val(data.dob);
		                $('[name="v_gender"]').val(data.sex);
		                $('[name="v_address"]').val(data.address);
		                $('[name="v_contact"]').val(data.phone)
		                $('[name="v_email"]').val(data.email);
		                $('[name="v_department"]').val(data.department);
		                $('[name="v_nationality"]').val(data.nationality);
		                $('[name="v_qualification"]').val(data.qualification);		
		            ...
		            error: function (jqXHR, textStatus, errorThrown)
		            {
		                swal("Error Occured!", "Teacher Records couldnot be viewed Now!", "error");
		            }
		        });
		    }

		    function delete_teacher(teacherid,name){
		        swal({
		            title: "Are you sure?",
		        ...
		        function(){
		            $.ajax({
		                url: "<?php echo base_url('admin/teachers/delete_teacher_record') ?>/" + teacherid,
		                type: "POST",
		                dataType: "JSON",
		                success: function (data)
		                {
		                    if (data.status) {
		                        swal("Teacher Deleted!",name+" Records deleted successfully!", "success");
		            ...
		            function (isConfirm) {
		                if (isConfirm) {
		                    $.ajax({
		                        type: "POST",
		                        data: {id: list_id},
		                        url: "<?php echo site_url('admin/teachers/bulk_teacher_delete');?>",
		                        dataType: "JSON",
		                        success: function (data){
		                            if (data.status)
		                            {
		                                swal("Teacher Deleted!", "Selected Teacher Records deleted successfully!", "success");
		                                //if success reload ajax table
		                                reload_table();
		                            } else
		                            {
		                    ...
		                    swal("Cancelled!", "Selected Teacher Records are NOT deleted!", "error");
		                }
		            });
		        } else
		        {
